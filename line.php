 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   $reply_message = 'ชื่อของฉัน คือ BOTME';
	   ...
	   if($text == "ใครคือผู้พัฒนาบอท" || $text == "ผู้สร้างบอทชื่ืออะไรครับ" || $text == "ผู้สร้างบอทชื่ืออะไรคะ" || $text == "ใครคือผู้พัฒนาบอทคะ" || $text == "ใครคือผู้พัฒนาบอทครับ" || $text == "ชื่อผู้พัฒนา" || $text == "ชื่อผู้พัฒนาบอท" ){
   $reply_message = 'ชื่อผู้สร้างฉัน คือ ลภัสรดา พุทธมงคล (Lapatrada Puttamnogkol)';
  }
	   
	    if($text == "ขอรหัสนิสิตหน่อยสิ" || $text == "ขอรหัสนิสิตหน่อยครับ" || $text == "ขอรหัสนิสิตหน่อยสิคะ" || $text == "ขอรหัสนิสิตหน่อยสิบอท" || $text == "ขอรหัสนิสิตผู้สร้างหน่อยสิบอท" || $text == "@บอทขอรหัสนิสิตของผู้พัฒนาหน่อย" || $text == "บอทขอรหัสนิสิตของผู้พัฒนาหน่อย" || $text == "รหัสนิสิตผู้พัฒนา" || $text == "รหัสนิสิตหน่อยบอท"){
   $reply_message = 'ชื่อรหัสนิสิตผู้สร้างฉัน คือ 61160071';
  }
