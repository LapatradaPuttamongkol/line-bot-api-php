 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   $reply_message = 'ชื่อผู้สร้างฉัน คือ ลภัสรดา พุทธมงคล (Lapatrada Puttamnogkol)';
	    ...
	    if($text == "ขอรหัสนิสิตหน่อยสิ" || $text == "ขอรหัสนิสิตหน่อยครับ" || $text == "ขอรหัสนิสิตหน่อยสิคะ" || $text == "ขอรหัสนิสิตหน่อยสิบอท" || $text == "ขอรหัสนิสิตผู้สร้างหน่อยสิบอท" || $text == "@บอทขอรหัสนิสิตของผู้พัฒนาหน่อย" || $text == "บอทขอรหัสนิสิตของผู้พัฒนาหน่อย"){
